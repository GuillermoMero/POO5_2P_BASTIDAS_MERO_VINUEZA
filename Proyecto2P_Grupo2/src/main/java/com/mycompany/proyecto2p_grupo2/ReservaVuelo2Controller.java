    ...
    public void cargarTarifa1(Tarifa t){
        ...
        Platform.runLater(new Runnable(){
            ...
            public void run(){
                ...
                mostrarVuelo3(vbTarifa1,valor,t);
            }
        });
    }
    ...
    public void cargarTarifa2(Tarifa t){
        ...
        Platform.runLater(new Runnable(){
            ...
            public void run(){
                ...
                mostrarVuelo3(vbTarifa2,valor,t);
            }
        });
    }
    ...
    public void cargarTarifa3(Tarifa t){
        ...
        Platform.runLater(new Runnable(){
            ...
            public void run(){
                ...
                mostrarVuelo3(vbTarifa3, valor,t);
            }
        });
    }
    ...
    public void mostrarVuelo3(VBox v, double valor, Tarifa t){
        v.setOnMouseClicked(new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent m){
                ConfirmacionCompraController.tarifaIda = t;
                DetallesVueloIdaController.tarifa = t;
                ReservaVuelo5Controller.vueloIda.setPrecio(valor);
